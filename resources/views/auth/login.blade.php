...
<div class="wrapper animated fadeInDown">
    <div class="panel overflow-hidden">
        <div class="bg-grey-900 padding-40 no-margin-bottom font-size-20 color-white text-center text-uppercase">
            <img src="{{ asset('assets/img/web/Logo.png') }}" width="100%" height="100%">
        </div>
        @if (count($errors) > 0)
        ...
        <div class="panel-footer padding-md no-margin no-border bg-grey-900 text-center color-white">&copy; {{date('Y')}} {{config('app.name')}} by Scientise7</div>
    </div>
</div>
